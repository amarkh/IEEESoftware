...
#define M0 0
#define M1 1
const int enca[] = {2,3}; // 2 is encA for back left motor. 3 is encA for front left motor.
const int encb[]= {7,4}; // 7 is encB for back left motor. 4 is encB for front left motor
const int pwm[] = {5,6}; // 5 is for back left wheel. 6 is for front left wheel.
const int in1[] = {8,9}; // 8 is for front left wheel. 9 is for back left wheel.
const int in2[] = {12,13}; // 12 is for front left wheel. 13 is for back left wheel.
