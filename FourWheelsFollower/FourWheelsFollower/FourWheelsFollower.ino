...
#define M0 0
#define M1 1
const int enca[] = {2,3}; // 2 is encA for back right motor. 3 is encA for right left motor.
const int encb[]= {7,4}; // 7 is encB for back left motor. 4 is encB for front left motor
const int pwm[] = {6,5}; // 6 is for back right wheel. 5 is for front right wheel.
const int in1[] = {8,9}; // 8 is for back right wheel. 9 is for front right wheel.
const int in2[] = {12,13}; // 12 is for back right wheel. 13 is for front right wheel.
